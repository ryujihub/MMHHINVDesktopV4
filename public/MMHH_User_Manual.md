...
# Metro Manila Hills Hardware — User Manual



## Features & Workflows

This section explains the main application workflows.

1) Products (Catalog)

- Add product: Click Add Product, enter product name, category, price, SKU/code, and starting stock.
- Edit product: Open a product row and click Edit to update details.
- Delete product: Use Delete from product actions (Admin-only depending on permissions).
- Stock adjustments: Adjust stock levels manually; system will update inventory value.
- Low stock alerts: Products below their defined reorder point will appear in the dashboard as low-stock items.
...
A: Use the export features (CSV/XLSX/DOCX) for reports and orders. 

Q: How do I add users?

A: Admins can create users in the User Management page. 
